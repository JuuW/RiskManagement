...
module.exports = cds.service.impl(async function () {
  ...
  /**
   * Set criticality after a READ operation on /risk
   */
...
/* event handler for read events on the businesspaterner entity, 
...
*/
  ...
  this.on("READ", Risks, async (req, next) => {
    ...
    */
    ...
    each business partner This code could be optimized, instead of 
    having n requests for n business partners, just one bulk request could be created  */
    try {
